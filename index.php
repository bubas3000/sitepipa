...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>Filipa e Gonçalo</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="Casamento Filipa e Gonçalo" />
					...
					<div class="display-tc">
						<div class="container">
							<div class="col-md-10 col-md-offset-1">
								...
								<!--<h1>The Wedding</h1>-->
									<h2>Filipa <small style="color: white;">e</small> Gonçalo</h2>
									<p><span>01.10.2022</span></p> 
								</div>
							</div>
						</div>
					</div>
			...
			<style>
				...
				* {box-sizing: border-box;}
				...
				.form-popup {
				  ...
				  top: 0;
  				  left: 0;
				  background-image: url(images/convite3.jpg);
					...
					<div class="container">
						<div class="row animate-box">
							<div class="col-md-8 col-md-offset-2 text-center heading-section">
								<h2 style="color: #4B756A;">Música que não pode faltar?</h2>
							</div>
						</div>
						<div class="row animate-box">
							<div class="col-md-10 col-md-offset-1">
